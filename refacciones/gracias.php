...
<body>
	...
	<div class="container">
		...
		<div class="picture-agencia">
			<picture>
				<!-- <source	media="(min-width: 900px)" srcset="../img/agencias/oaxaca_720px.jpg" class="size-50"> -->
				<img class="size-50" src="../img/servicio/servicio02.jpg" alt="Servicio Grupo Vecsa">				
			</picture>
		</div>	
		<div class="content">
			<div class="side-fixed-menu">
				<ul class="menu-agencia">
					<li>
						<a href="cita.php"><span class="icon-phone"></span>Cita se servicio</a>
					</li>
					<li>
						<a href=""><span class="icon-phone"></span>Quejas y sugerencias</a>
					</li>
					<!-- <li>
			...
			<section class="datos-agencia">
				<div class="envelope-icon">
					<p class="gracias"> Agradecemos su visita al sitio de BMW Vecsa. Hemos recibido su solicitud.</p>
        			<p class="gracias">En breve recibirá información de nuestro Departamento de Refacciones mientras se prepara su información.</p>								
				</div>
			</section>			
		</div>			
	</div>  <!-- end container -->
