		...
		<div class="content">
			...
			<section class="datos-agencia">
				<div class="envelope-icon">
					<p class="gracias">Gracias por ponerse en contacto, hemos recibido su solicitud de servicio.</p>
	        		<p class="gracias">En breve nos pondremos en contacto con usted para confirmar la fecha y hora.</p>								
				</div>
			</section>			
		</div>			
	</div>  <!-- end container -->
