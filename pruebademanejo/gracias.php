...
<body>
	...
	<picture>
		<img class="pic-header" src="../img/promociones/serie2_active_tourer_01.jpg" alt="agencia Vecsa Puebla">
	</picture>
	...
	<div class="container">
		...
		<div class="picture-agencia">
			<picture>
				<img class="size-50" src="../img/promociones/serie2_active_tourer_01.jpg">				
			</picture>
		</div>	
		<div class="content">
			...
			<section class="datos-agencia">
				<div class="envelope-icon">
					<p class="gracias">Gracias por ponerse en contacto, hemos recibido su solicitud.</p>
